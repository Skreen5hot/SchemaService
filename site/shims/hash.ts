/**
 * Pure-JS SHA-256 for browser builds (ADR-005).
 *
 * Replaces node:crypto at bundle time via esbuild alias.
 * Only used for hashing ≤1024 bytes of input (JSON Schema $id).
 */
